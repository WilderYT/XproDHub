...
local playerListExpanded = false

local playerDropdownHeader = Instance.new("Frame", espContent)
playerDropdownHeader.Size = UDim2.new(1, 0, 0, 32)
playerDropdownHeader.Position = UDim2.new(0, 0, 0, 152)
playerDropdownHeader.BackgroundColor3 = Color3.fromRGB(45, 45, 55)
playerDropdownHeader.BorderSizePixel = 0

local headerCorner = Instance.new("UICorner", playerDropdownHeader)
headerCorner.CornerRadius = UDim.new(0, 8)

local headerGlow = Instance.new("UIStroke", playerDropdownHeader)
headerGlow.Color = Color3.fromRGB(100, 200, 255)
headerGlow.Thickness = 1
headerGlow.Transparency = 0.7

local headerLabel = Instance.new("TextLabel", playerDropdownHeader)
headerLabel.Size = UDim2.new(1, -40, 1, 0)
headerLabel.Position = UDim2.new(0, 10, 0, 0)
headerLabel.Text = "Select Player to Teleport"
...
local arrowButton = Instance.new("TextButton", playerDropdownHeader)
arrowButton.Size = UDim2.new(0, 24, 0, 24)
arrowButton.Position = UDim2.new(1, -30, 0.5, -12)
arrowButton.BackgroundColor3 = Color3.fromRGB(70, 70, 80)
arrowButton.Text = "▼"
...
local arrowGlow = Instance.new("UIStroke", arrowButton)
arrowGlow.Color = Color3.fromRGB(100, 200, 255)
arrowGlow.Thickness = 0
arrowGlow.Transparency = 1

local selectedPlayerLabel = Instance.new("TextLabel", playerDropdownHeader)
selectedPlayerLabel.Size = UDim2.new(0, 100, 0, 14)
selectedPlayerLabel.Position = UDim2.new(0, 10, 1, -16)
selectedPlayerLabel.Text = "None Selected"
selectedPlayerLabel.BackgroundTransparency = 1
selectedPlayerLabel.TextColor3 = Color3.fromRGB(150, 150, 150)
...
local playerListContainer = Instance.new("Frame", espContent)
playerListContainer.Size = UDim2.new(1, 0, 0, 0)
playerListContainer.Position = UDim2.new(0, 0, 0, 184)
playerListContainer.BackgroundColor3 = Color3.fromRGB(40, 40, 50)
playerListContainer.BorderSizePixel = 0
playerListContainer.ClipsDescendants = true

local containerCorner = Instance.new("UICorner", playerListContainer)
containerCorner.CornerRadius = UDim.new(0, 8)

local containerGlow = Instance.new("UIStroke", playerListContainer)
containerGlow.Color = Color3.fromRGB(100, 200, 255)
containerGlow.Thickness = 1
containerGlow.Transparency = 0.7

local playerList = Instance.new("ScrollingFrame", playerListContainer)
playerList.Size = UDim2.new(1, 0, 1, 0)
playerList.Position = UDim2.new(0, 0, 0, 0)
playerList.BackgroundTransparency = 1
playerList.CanvasSize = UDim2.new(0, 0, 0, 0)
playerList.ScrollBarThickness = 4
playerList.ScrollBarImageColor3 = Color3.fromRGB(100, 200, 255)
...
arrowButton.MouseEnter:Connect(function()
    TweenService:Create(arrowGlow, TweenInfo.new(0.2, Enum.EasingStyle.Quad), {
        Thickness = 1.5,
        Transparency = 0.4
    }):Play()
    TweenService:Create(arrowButton, TweenInfo.new(0.15, Enum.EasingStyle.Back), {
        Size = UDim2.new(0, 26, 0, 26)
    }):Play()
end)
...
local function togglePlayerDropdown()
    playerListExpanded = not playerListExpanded
    
    if playerListExpanded then
        arrowButton.Text = "▲"
        TweenService:Create(playerListContainer, TweenInfo.new(0.3, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {
            Size = UDim2.new(1, 0, 0, 80)
        }):Play()
        TweenService:Create(arrowButton, TweenInfo.new(0.2, Enum.EasingStyle.Quad), {
            Rotation = 180
        }):Play()
        TweenService:Create(headerGlow, TweenInfo.new(0.2, Enum.EasingStyle.Quad), {
            Color = Color3.fromRGB(0, 170, 255),
            Transparency = 0.4
        }):Play()
    else
        arrowButton.Text = "▼"
        TweenService:Create(playerListContainer, TweenInfo.new(0.3, Enum.EasingStyle.Back, Enum.EasingDirection.In), {
...
arrowButton.MouseButton1Click:Connect(togglePlayerDropdown)
...
btnSelf.Size = UDim2.new(1, -4, 0, 24)
btnSelf.Text = "🚫 Disable Teleport"
btnSelf.Font = Enum.Font.GothamBold
btnSelf.TextColor3 = Color3.fromRGB(255, 255, 255)
btnSelf.BackgroundColor3 = Color3.fromRGB(70, 70, 100)
btnSelf.BorderSizePixel = 0
btnSelf.Parent = playerList

local btnSelfCorner = Instance.new("UICorner", btnSelf)
btnSelfCorner.CornerRadius = UDim.new(0, 4)

btnSelf.MouseEnter:Connect(function()
    if btnSelf.BackgroundColor3 ~= Color3.fromRGB(255, 90, 90) then
        TweenService:Create(btnSelf, TweenInfo.new(0.2, Enum.EasingStyle.Quad), {
            BackgroundColor3 = Color3.fromRGB(90, 90, 120)
        }):Play()
    end
end)

btnSelf.MouseLeave:Connect(function()
    if btnSelf.BackgroundColor3 ~= Color3.fromRGB(255, 90, 90) then
        TweenService:Create(btnSelf, TweenInfo.new(0.2, Enum.EasingStyle.Quad), {
...
btnSelf.MouseButton1Click:Connect(function()
    ...
    selectedPlayerLabel.Text = "Teleport Disabled"
    selectedPlayerLabel.TextColor3 = Color3.fromRGB(255, 90, 90)
    tpEnabled = false
    
    for _, b in ipairs(playerList:GetChildren()) do
        if b:IsA("TextButton") then
            TweenService:Create(b, TweenInfo.new(0.2, Enum.EasingStyle.Quad), {
                BackgroundColor3 = b == btnSelf and Color3.fromRGB(255, 90, 90) or Color3.fromRGB(60, 60, 70)
            }):Play()
        end
    end
...
for _, plr in ipairs(Players:GetPlayers()) do
    if plr ~= LocalPlayer and plr.Character and plr.Character:FindFirstChild("HumanoidRootPart") then
        ...
        btn.MouseButton1Click:Connect(function()
            selectedPlayer = plr
            selectedPlayerLabel.Text = plr.Name
            selectedPlayerLabel.TextColor3 = Color3.fromRGB(0, 170, 255)
            
            for _, b in ipairs(playerList:GetChildren()) do
                if b:IsA("TextButton") then
                    TweenService:Create(b, TweenInfo.new(0.2, Enum.EasingStyle.Quad), {
                        BackgroundColor3 = b == btn and Color3.fromRGB(0, 170, 255) or 
                                         (b == btnSelf and Color3.fromRGB(70, 70, 100) or Color3.fromRGB(60, 60, 70))
                    }):Play()
                end
            end
...
playerList.CanvasSize = UDim2.new(0, 0, 0, count * 26)
end
...
enhanceTouchTarget(arrowButton)
end
...
print("🎯 NEW: Collapsible player teleport dropdown with arrow button!")
